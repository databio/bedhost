...
export const UMAP_PARQUET_URL =
  'https://huggingface.co/databio/bedbase-umap/resolve/main/hg38_umap_all_3_13.parquet';
// export const UMAP_PARQUET_URL = `${window.location.origin}/hg38_umap_all_3_13.parquet`;
