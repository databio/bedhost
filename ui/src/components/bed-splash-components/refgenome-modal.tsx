    ...
    >
      ...
      <Modal.Body>
        <p className='text-sm'>
          ...
          (tier 1 is best). The ranking is based on the following metrics:
        </p>
        <ul className='text-sm'>
          <li>
            <strong>XS</strong> (eXtra Sequences): the proportion of shared regions in both this BED file and reference
            genome over the total number of regions in this BED file [recall].
          </li>
          <li>
            <strong>OOBR</strong> (Out Of Bounds Regions): The proportion of shared regions from this BED file that do
            not exceed the bounds of the corresponding shared region in the reference genome. OOBR is only calculated if
            XS is 100%.
          </li>
          <li>
            <strong>SF</strong> (Sequence Fit): the proportion of shared{' '}
            <span className='fst-italic'>region lengths</span> in both this BED file and reference genome over the total
        ...
        <div className='row mb-1'>
          <div className='col-12'>
            <div className='d-flex align-items-center gap-2 px-3 fw-medium text-sm'>
              <p className='mb-1' style={{ width: '33%' }}>
                Genome
              </p>
              <p className='mb-1 mx-2' style={{ width: '14%' }}>
                XS
              </p>
              <p className='mb-1 mx-2' style={{ width: '14%' }}>
                OOBR
          ...
          .map((genome) => (
            ...
            >
              <div
                ...
                style={{
                  backgroundColor:
                    genome.tier_ranking == 1
                      ? '#C8EFB3A0'
                      : genome.tier_ranking == 2
                        ? '#FFF7BAA0'
                        : genome.tier_ranking == 3
                          ? '#F9D39DA0'
                          : '#FCB6B6A0',
                }}
                key={genome.compared_genome}
                  ...
                  <div className='row'>
                    <div className='col-12'>
                      <div className='d-flex align-items-center gap-2'>
                        <p className='mb-1 fw-semibold' style={{ width: '33%' }}>
                        ...
                        <div className='rounded-1 mx-2 bg-white position-relative' style={{ width: '14%' }}>
                          {genome.xs ? (
                            <>
                              ...
                              <div
                                className='rounded-1 bg-primary'
