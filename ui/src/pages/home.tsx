            ...
            <div className="d-flex flex-column w-100 align-items-center p-2">
                ...
                <div className="w-75">
                    <p className="text-center text-base mb-4">
                        ...
                        BEDbase redefines
                        the way to manage genomic region data and allows users to search for BED files of interest and
                        create
                        collections tailored to research needs. BEDbase is composed of a web server and an API. Users
                        can explore
            ...
            <span className="d-flex align-items-center">
              ...
              Search
                ...
                <div className="d-flex flex-row align-items-center justify-content-center gap-2 my-3">
                    Or, explore an <a href={`/bed/${exampleBedMetadata?.id || 'not-found'}`}>example BED file</a> or
                    a{' '}
                ...
                <div className="flex-row w-100 landing-animation-container hidden large-flex">
                    ...
                    <div className="d-flex flex column h-100 align-items-center">
                        <div className="p-2 border border-primary rounded rounded border-2 landing-main-logo-shadow">
                            <Image src="/bedbase_icon.svg" alt="BEDbase logo" height="125px"
                                   className="landing-animation-logo"/>
                        </div>
                    </div>
                    <OutPaths/>
                ...
                <div className="my-2 w-100">
                    <Row className="w-100 align-items-center mb-5">
                        <Col sm={6} md={6}>
                            ...
                            <p className="text-balance pe-4">
                                The BEDbase web server and API are designed to provide a user-friendly interface for
                                exploring and
                                working with genomic region data. The web server allows users to search for BED files
                                and BED sets, view
                    ...
                    <Row className="w-100 mb-5">
                        <Col sm={6} md={6}>
                            ...
                            <p className="text-balance pe-4">
                                ...
                                other platforms by utilizing Elasticsearch to index and search through bed file regions.
                                This approach
                                enhances search accuracy and efficiency compared to platforms relying on unstructured
                                user-provided
                                metadata, which can be ambiguous and less reliable. User can search for BED files by
                                providing a query
                        ...
                        <Col sm={6} md={6}>
                            <div
                                className="d-flex flex-row align-items-center width-100 justify-content-center h-100 gap-1">
                                <input
                    ...
                    <Row className="w-100 align-items-center">
                        <Col sm={6} md={6}>
                            ...
                            <p className="text-balance pe-4">
                                BEDbase provides a Python an R client for interacting with the BEDbase API. The client
                                allows users to
                                download, cache, and analyze BED files and BED sets programmatically, without the need
                                to interact with
                                the native API. BBclient is available on PyPI in geniml package with other useful tools
                                for genomic data
