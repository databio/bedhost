...
export default class QueryBuilderWrapper extends React.Component {
    ...
    componentDidMount() {
        const element = this.queryBuilder;
        initializeQueryBuilder(element);
    }

    componentWillUnmount() {
        window.$(this.queryBuilder).queryBuilder('destroy');
    }
    ...
    handleGetRulesClick() {
        const rules = window.$(this.queryBuilder).queryBuilder('getRules');
    ...
    handleSetRulesClick() {
        ...
        window.$(this.queryBuilder).queryBuilder('setRules', newRules);
